          ...
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            ...
            <div className="mb-4">
              {heroImagePreview ? (
                ...
                <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-slate-300 rounded-lg cursor-pointer hover:border-brand-500 transition-colors bg-slate-50">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            ...
            <div className="space-y-6">
                      ...
                      <div className="relative inline-block">
                        {opp.icon ? (
                          ...
                          <label className="cursor-pointer">
                            <div className="w-24 h-24 border-2 border-dashed border-slate-300 rounded-lg flex items-center justify-center hover:border-brand-500 transition-colors">
              ...
              <button
                ...
                className="w-full py-2 border-2 border-dashed border-slate-300 rounded-lg text-slate-600 hover:border-brand-500 hover:text-brand-600 transition-colors flex items-center justify-center gap-2"
              >
