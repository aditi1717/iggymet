...
import { DailyIncentiveDetailsV2 } from './pages/pocket/DailyIncentiveDetailsV2';
  ...
  return (
    <Suspense fallback={<Loader />}>
      <Routes>
        ...
        <Route path="/pocket/incentives" element={<ProtectedRoute><DailyIncentiveDetailsV2 /></ProtectedRoute>} />
