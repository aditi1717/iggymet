...
router.get('/delivery/daily-incentives', adminController.getDailyIncentiveCampaigns);
router.post('/delivery/daily-incentives', adminController.createDailyIncentiveCampaign);
router.patch('/delivery/daily-incentives/:id', adminController.updateDailyIncentiveCampaign);
router.delete('/delivery/daily-incentives/:id', adminController.deleteDailyIncentiveCampaign);
router.patch('/delivery/daily-incentives/:id/status', adminController.toggleDailyIncentiveCampaignStatus);
